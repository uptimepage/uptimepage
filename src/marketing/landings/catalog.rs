...
docker compose up -d"#,
        ...
        resources: &[
            ResourceLink {
                label: "11 open-source status pages, compared",
                href: "/blog/best-open-source-status-pages",
            },
            ResourceLink {
...
tail -c 4000 backup.log | curl -fsS --data-binary @- "$URL/$code""#,
  ...
  check = {
    ...
    Landing {
        ...
        meta_description: "Uptime Kuma is a monitoring dashboard that can publish a page. Kener is a status page with checks attached. Check types, branding, API, roles. September 2026.",
