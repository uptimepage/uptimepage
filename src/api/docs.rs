...
#[openapi(
    ...
    paths(
        ...
        handlers::billing::get_billing,
        handlers::billing::checkout,
        handlers::billing::portal,
        handlers::billing::change_plan,
        handlers::billing::cancel,
        handlers::billing::revoke_cancel,
